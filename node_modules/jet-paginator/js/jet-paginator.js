...
var jetPaginator = function(){

    function jetPaginator(config) {
        // throw errors if insufficient parameters were given
        if (typeof config != "object")
            throw "jetPaginator was expecting a config object!";
        if (typeof config.get_rows != "function" && !(config.table instanceof Element))
            throw "jetPaginator was expecting a table or get_row function!";
