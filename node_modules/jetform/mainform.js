...
{
    function mainForm(jsonInfo,rootElemnt)
    {
        this.jsonInfo = jsonInfo;
        //this.jsonsetup = jsonsetup;
        this.rootElement = rootElemnt;
        mainForm.DoLayout(jsonInfo,rootElemnt);
        console.log("foomar");
    }
    ...
    mainForm.PopupContainer = function()
    {
    ...
    mainForm.DialogContainer= function(popup,formName)
    {
    ...
    mainForm.createFormContent = function(theFormContainer,jsonInfo)
    {
        ...
        formC.setAttribute("onsubmit",'mainForm.xhr(jsonInfo.formId)');
        ...
        for (var i = 0; i < jsonInfo.formElements.length; i++) {
            ...
            {
                mainForm.formTextbox(DialogConTent,jsonInfo.formElements[i]);
            }
            if(jsonInfo.formElements[i].type == "dropBox")
            {
                //mainForm.formTextbox(DialogConTent,);
                mainForm.SelectComponent(DialogConTent,jsonInfo.formElements[i]);
            }
            if(jsonInfo.formElements[i].type == "checkBox")
            {
                mainForm.formCreateCheck(DialogConTent,jsonInfo.formElements[i]);

            }
            if(jsonInfo.formElements[i].type == "fileSelect")
            {
                mainForm.formFileUpload(DialogConTent,jsonInfo.formElements[i]);

            }
        }
        //mainForm.formTextbox(DialogConTent);
        //mainForm.formCreateCheck(DialogConTent);

        //mainForm.SelectComponent(DialogConTent);
        //mainForm.formFileUpload(DialogConTent);
        //
        return formC;
    ...
    //defaultOptions
    //
    mainForm.formFileUpload = function (DialogConTent,jsonFormElements)
    {
        //                        <div class="row-component">
        //
        //                            <div class="text-box-component">
        ...
        //file_input.setAttribute("onchange","mainForm.selectFile(event.files)")
        rowComponent.appendChild(file_input);
        //document.getElementById("ffile").addEventListener("change", mainForm.selectFile, false);
    ...
    //checkbox
    mainForm.formCreateCheck = function(DialogConTent,jsonFormElements)
    {
        console.log("=================");
        console.log(jsonFormElements);
        var rowComponent = document.createElement("div");
    ...
    //SelectComponent
    mainForm.SelectComponent = function(DialogConTent,jsonFormElements)
    {
        console.log(jsonFormElements);
    ...
    //TextBox Imput
    mainForm.formTextbox = function (DialogConTent,jsonFormElements)
    {
        //         console.log(jsonFormElements);
        //         console.log("------------------");
        //
    ...
    mainForm.footer = function(DialogConTent)
    {
...
mainForm.AllocateInlineContent = function(appendPanel)
{
...
return pane;
    ...
    mainForm.DoLayout = function(jsonInfo,appendPanel)
    {
...
//    var popup = mainForm.PopupContainer();
    var popup = mainForm.AllocateInlineContent(appendPanel);
//    var theFormContainer = mainForm.DialogContainer(popup,jsonInfo.formName)
    var theform = mainForm.createFormContent(popup,jsonInfo);
    //mainForm.footer(theFormContainer);
    mainForm.footer(theform);
...
mainForm.xhr = function functionName(formId) {
