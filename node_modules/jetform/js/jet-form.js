...
var jetform = function()
{
    function jetform(jsonInfo,rootElemnt)
    {
        this.jsonInfo = jsonInfo;
        //this.jsonsetup = jsonsetup;
        this.rootElement = rootElemnt;
        jetform.DoLayout(jsonInfo,rootElemnt);
        console.log("foomar");
    }
    ...
    jetform.PopupContainer = function()
    {
    ...
    jetform.DialogContainer= function(popup,formName)
    {
    ...
    jetform.createFormContent = function(theFormContainer,jsonInfo)
    {
        ...
        formC.setAttribute("onsubmit",'jetform.xhr(jsonInfo.formId)');
        ...
        for (var i = 0; i < jsonInfo.formElements.length; i++) {
            ...
            {
                jetform.formTextbox(DialogConTent,jsonInfo.formElements[i]);
            }
            if(jsonInfo.formElements[i].type == "dropBox")
            {
                //jetform.formTextbox(DialogConTent,);
                jetform.SelectComponent(DialogConTent,jsonInfo.formElements[i]);
            }
            if(jsonInfo.formElements[i].type == "checkBox")
            {
                jetform.formCreateCheck(DialogConTent,jsonInfo.formElements[i]);

            }
            if(jsonInfo.formElements[i].type == "fileSelect")
            {
                jetform.formFileUpload(DialogConTent,jsonInfo.formElements[i]);

            }
        }
        //jetform.formTextbox(DialogConTent);
        //jetform.formCreateCheck(DialogConTent);

        //jetform.SelectComponent(DialogConTent);
        //jetform.formFileUpload(DialogConTent);
        //
        return formC;
    ...
    //defaultOptions
    //
    jetform.formFileUpload = function (DialogConTent,jsonFormElements)
    {
        //                        <div class="row-component">
        //
        //                            <div class="text-box-component">
        ...
        //file_input.setAttribute("onchange","jetform.selectFile(event.files)")
        rowComponent.appendChild(file_input);
        //document.getElementById("ffile").addEventListener("change", jetform.selectFile, false);
    ...
    //checkbox
    jetform.formCreateCheck = function(DialogConTent,jsonFormElements)
    {
        console.log("=================");
        console.log(jsonFormElements);
        var rowComponent = document.createElement("div");
    ...
    //SelectComponent
    jetform.SelectComponent = function(DialogConTent,jsonFormElements)
    {
        console.log(jsonFormElements);
    ...
    //TextBox Imput
    jetform.formTextbox = function (DialogConTent,jsonFormElements)
    {
        //         console.log(jsonFormElements);
        //         console.log("------------------");
        //
    ...
    jetform.footer = function(DialogConTent)
    {
...
jetform.AllocateInlineContent = function(appendPanel)
{
...
return pane;
    ...
    jetform.DoLayout = function(jsonInfo,appendPanel)
    {
...
//    var popup = jetform.PopupContainer();
    var popup = jetform.AllocateInlineContent(appendPanel);
//    var theFormContainer = jetform.DialogContainer(popup,jsonInfo.formName)
    var theform = jetform.createFormContent(popup,jsonInfo);
    //jetform.footer(theFormContainer);
    jetform.footer(theform);
...
jetform.xhr = function functionName(formId) {
